...
description: Esplora le best practice consigliate dagli esperti di Adobe Workfront in merito all’impostazione, alla gestione e all’utilizzo delle code di richieste Workfront.
...
* Includi una descrizione per ogni elemento di una coda di richieste, ovvero il progetto della coda di richieste, i gruppi di argomenti, gli argomenti della coda e le regole di indirizzamento.
...
* Evita di condividere le code di richieste con “tutti”. Imposta le impostazioni dei dettagli della coda in modo che gli utenti possano visualizzare solo le code pertinenti alle proprie esigenze.

* Crea e assegna una dashboard contenente i report della coda di richieste in modo che i gestori del traffico, gli amministratori di sistema o gli utenti assegnati possano lavorare direttamente sui problemi.

* Utilizza i modelli layout per rimuovere le opzioni di configurazione della coda richieste dal menu del pannello a sinistra dei progetti, per gli utenti che non hanno bisogno di creare code.

* Crea una coda di richieste di amministratore di sistema per consentire agli utenti di porre domande relative a Workfront, effettuare richieste relative alle impostazioni di sistema, pianificare nuovi corsi di formazione per gli utenti, ecc.

* Controlla regolarmente le code di richieste di audit per identificare e annullare la condivisione delle code non utilizzate.
...
* Controlla il numero totale di code di richieste disponibili per gli utenti suddividendo una coda di richieste utilizzando gruppi di argomenti e argomenti della coda, anziché creare più code.

* Configura le regole di indirizzamento per ogni argomento della coda. Imposta almeno una regola di indirizzamento predefinita.

* Utilizza i gruppi di argomenti e gli argomenti della coda quando è necessario l’indirizzamento selettivo.
...
Le descrizioni consentono agli amministratori di gruppo, ai futuri amministratori di sistema o ad altri che gestiscono code di richieste di sapere esattamente cosa fa ogni parte della coda di richieste.

Le informazioni descrittive vengono visualizzate anche quando passi il puntatore sull’icona delle informazioni nel campo della finestra della nuova richiesta.
...
Crea uno stato di problema denominato “Rifiutato” quando utilizzi approvazioni di problemi e imposta l’opzione Se rifiutato sullo stato “Rifiutato”.
...
Consentire agli utenti di accedere in modo semplice e rapido alle richieste in arrivo significa non perdere il lavoro nella confusione.
...
Un audit regolare delle impostazioni e degli elementi nel sistema Adobe Workfront consente di mantenerlo ordinato e privo di elementi non necessari. Se una coda non viene più utilizzata o monitorata, assicurati che gli utenti non possano più accedervi in modo che le richieste di lavoro vengano prese in considerazione.
...
I gruppi di argomenti aumentano l’adozione da parte degli utenti e creano meno confusione diminuendo l’elenco iniziale di opzioni tra cui scegliere. Questo consente agli utenti di trovare facilmente ciò che cercano senza sopraffarli quando tentano di inviare una richiesta.
...
Crea più code di richiesta se è necessario un accesso diverso per le diverse code di richiesta o se il consolidamento delle code potrebbe confondere gli utenti.
...
Le regole di indirizzamento garantiscono che a qualcuno venga sempre assegnata la richiesta in ingresso in modo che il lavoro non vada perduto.
...
Non è possibile applicare le regole di indirizzamento ai campi di un modulo personalizzato. Pertanto, se è necessario indirizzare diversi tipi di richieste a team/singoli utenti diversi, imposta ogni tipo di richiesta come gruppo di argomenti/argomento della coda in modo che il lavoro possa essere indirizzato correttamente.
...
Quando le richieste vengono inviate al team, questo offre all’intero team la visibilità delle richieste in corso e di ciò che potrebbe comportare il lavoro in programma. Tutti possono osservare la pagina Team per trovare nuovi elementi o tenere traccia delle novità con un rapporto su una dashboard.
