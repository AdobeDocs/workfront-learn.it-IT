...
description: Esplora i consigli sulle best practice forniti dagli esperti di Adobe Workfront in merito alla configurazione e alla gestione dei moduli personalizzati di Workfront.
...
* Controllare la libreria dei campi prima di creare nuovi campi per un modulo personalizzato per verificare se il campo esiste già.
...
Queste informazioni vengono visualizzate come popup quando passi il puntatore sul pulsante con l’icona ? che si trova accanto a un campo in un modulo personalizzato. Includi i dati da immettere nel campo, compresa l’eventuale formattazione richiesta per specifici campi di testo.
