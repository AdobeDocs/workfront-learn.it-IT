...
* Utilizza i controlli elenco nei modelli layout per nascondere filtri, viste e raggruppamenti non necessari per gli oggetti utilizzati più spesso (progetti, attività, programmi, ecc.).

* Tramite i controlli elenco sui modelli layout, puoi condividere filtri, viste e raggruppamenti personalizzati in base ai flussi di lavoro e ai processi della tua organizzazione.
...
Se hai creato filtri, viste e raggruppamenti che mostrano informazioni specifiche dei processi giornalieri degli utenti, è facile condividerli attraverso i modelli layout. In questo modo, tutti gli utenti assegnati al modello layout avranno a disposizione opzioni di filtro, vista e raggruppamento rilevanti per i propri flussi di lavoro.

La personalizzazione delle informazioni che desideri rendere visibili agli utenti tramite i modelli di layout consente inoltre di risparmiare tempo agli amministratori di sistema e di gruppi, in quanto non dovranno condividere singolarmente ogni opzione di filtro, vista o raggruppamento.
