...
1. Per Output, seleziona ID, Nome, Descrizione, Numero di elementi secondari, Numero di problemi aperti e Lavoro.
...
1. Nel campo Valore variabile, sottrai il numero di elementi secondari aperti dal numero di operazioni opTasks aperte.
