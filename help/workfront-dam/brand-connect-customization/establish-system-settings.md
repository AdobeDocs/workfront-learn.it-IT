...
* **Chi può pubblicare su questo portale?**—Imposta i gruppi che possono pubblicare risorse su [!UICONTROL Brand Connect]. Questi saranno i gruppi collaboratori. Possono pubblicare solo gli elementi a cui hanno accesso.
* **Chi può gestire le linee guida per i marchi?**—Impostare i gruppi che possono gestire le linee guida per i marchi. La gestione delle linee guida non è limitata agli utenti amministratori. È possibile impostare un gruppo collaboratori per modificare le linee guida.
* **Visualizzare il portale nei motori di ricerca?**. Visualizzare l&#39;URL di [!UICONTROL Brand Connect] quando le ricerche vengono eseguite su Internet?
* **Consenti collegamenti incorporabili?**—I collegamenti incorporabili possono provenire da [!UICONTROL Brand Connect]? In questo modo verrà aggiunto un pannello [!UICONTROL Ottieni collegamenti] al menu [!UICONTROL Condividi], che fornisce collegamenti incorporabili per la risorsa.
* **Abilitare/disabilitare i social network?** - Se i social network sono abilitati (selezionare la casella di controllo), gli utenti potranno aggiungere un Mi piace e un commento alle risorse.
* **Abilitare/disabilitare il download e il conteggio delle visualizzazioni?** - Se abilitati, gli utenti possono vedere quante volte una risorsa è stata scaricata e quanti commenti contiene.
