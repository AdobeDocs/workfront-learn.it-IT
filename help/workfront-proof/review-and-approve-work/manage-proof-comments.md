...
Se non visualizzi le azioni elencate nei commenti, significa che la tua organizzazione non le ha configurate. Rivolgiti all’amministratore del sistema di verifica delle bozze se ritieni che le azioni debbano essere utilizzate dall’organizzazione.
...
![Immagine dei filtri di commento nel visualizzatore di bozze con le opzioni filtro [!UICONTROL Azioni] e [!UICONTROL Generale] evidenziate.](assets/manage-comments-3.png)
