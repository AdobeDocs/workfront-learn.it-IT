...
+ Reporting {#reporting}
   + Rapporti di base {#basic-reporting}
      ...
      + [Aggiungi formattazione condizionale di base](reporting/basic-reporting/add-basic-conditional-formatting-to-a-view.md)
      ...
      + [Creare un rapporto attività](reporting/basic-reporting/create-a-task-report.md)
      + [Creare rapporti con grafici](reporting/basic-reporting/create-reports-with-charts.md)
      + [Creare un rapporto sulla matrice](reporting/basic-reporting/create-a-matrix-report.md)
      + [Creare dashboard](reporting/basic-reporting/create-dashboards.md)
      + [Inviare e condividere rapporti](reporting/basic-reporting/how-to-send-and-share-reports.md)
      + [Comprendere le impostazioni del rapporto](reporting/basic-reporting/report-settings.md)
      + [Comprendere l’interfaccia del calendario](reporting/basic-reporting/tour-of-the-interface.md)
      + [Crea un calendario personalizzato](reporting/basic-reporting/creating-custom-calendars.md)
      + [Comprendere le opzioni di calendario aggiuntive](reporting/basic-reporting/additional-calendar-options.md)
      + [Il turno per creare un calendario](reporting/basic-reporting/your-turn-to-create-a-calendar.md)
   + Rapporti intermedi {#intermediate-reporting}
      ...
      + [Creare filtri con caratteri jolly basati su data](reporting/intermediate-reporting/create-filters-with-date-based-wildcards.md)
      + [Creare istruzioni OR nei filtri](reporting/intermediate-reporting/or-statements-in-filters.md)
      + [Informazioni sui filtri di progetto incorporati](reporting/intermediate-reporting/open-built-in-project-filters.md)
      + [Comprendere i filtri attività incorporati](reporting/intermediate-reporting/open-built-in-task-filters.md)
      + [Informazioni sui filtri dei problemi incorporati](reporting/intermediate-reporting/open-built-in-issue-filters.md)
   ...
   + Rapporti avanzati {#advanced-reporting}
   ...
   + Funzionalità di analisi avanzate {#enhanced-analytics}
      + [Un momento con prodotto su [!UICONTROL Analisi avanzata]](reporting/enhanced-analytics/1-intro-to-workfront-analytics.md)
      ...
      + [Comprendere il lavoro e i grafici delle persone](reporting/enhanced-analytics/5-work-and-people-charts.md)
      + [Comprendere i filtri](reporting/enhanced-analytics/6-filters-overview.md)
      + [Comprendere intervalli di date e intervalli di tempo](reporting/enhanced-analytics/7-date-ranges-vs-timeframes.md)
      + [Comprendere le visualizzazioni delle ore e della durata pianificate](reporting/enhanced-analytics/8-planned-hours-and-duration-views.md)
      ...
      + [Navigazione e revisione dei progetti](reporting/enhanced-analytics/11-navigating-and-reviewing-projects.md)
      ...
      + [Comprendere la navigazione e la revisione dell’attività del progetto](reporting/enhanced-analytics/13-navigating-and-reviewing-project-activity.md)
      + [Approfondisci la navigazione](reporting/enhanced-analytics/14-navigation-and-digging-deeper.md)
      + [Comprendere l’accesso e la revisione del menu a discesa](reporting/enhanced-analytics/15-accessing-and-reviewing-the-burndown.md)
      + [Rivedere le attività in volo](reporting/enhanced-analytics/16-navigating-to-and-reviewing-the-tasks-in-flight.md)
      + [Intervenire con aggiornamenti](reporting/enhanced-analytics/17-taking-action-by-making-updates.md)
      + [Comprendere l’attività in base al grafico del team](reporting/enhanced-analytics/18-activity-by-team-chart.md)
      ...
      + [Comprendere un caso d’uso di confronti di KPI](reporting/enhanced-analytics/21-kpi-comparisons.md)
      + [Comprendere un caso d’uso finale](reporting/enhanced-analytics/22-end-user-use.md)
      + [Comprendere le linee guida di consulenza](reporting/enhanced-analytics/23-consulting-guidance.md)
...
+ Gestione delle risorse {#manage-resources}
   + Gestione risorse {#resource-management}
      + [Scadenza gestione risorse](manage-resources/resource-management/resource-management-maturity.md)
...
+ Workfront Goals {#workfront-goals}
   ...
   + Creare gli obiettivi {#create-goals}
      + [[!UICONTROL Obiettivi di Workfront] Panoramica](workfront-goals/create-your-goals/understand-how-to-use-workfront-goals.md)
   ...
   + Gestire gli obiettivi {#manage-goals}
      ...
      + [Aggiornare i progressi relativi a risultati e attività](workfront-goals/manage-your-goals/make-a-quantitative-update.md)
...
+ Integrazioni {#integrations}
   + Adobe Creative Cloud {#adobe-creative-cloud}
      + [Utilizzare i plug-in Adobe Workfront per Creative Cloud](integrations/adobe-creative-cloud/use-adobe-workfront-extensions-for-creative-cloud.md)
   + Adobe Experience Manager Assets Essentials {#adobe-assets-essentials}
      ...
      + [Cronologia delle versioni](https://experienceleague.adobe.com/docs/experience-manager-learn/assets-essentials/workfront/versions.html)
   + Suite G {#g-suite-integrations}
      + [Migliorare il flusso di lavoro con l&#39;integrazione di G Suite](integrations/g-suite-integrations/worfront-for-g-suite-integrations.md)
   + Jira {#jira}
      + [Crea visibilità con [!DNL Jira] Integrazione](integrations/jira/jira.md)
   + Microsoft Outlook {#outlook}
      + [Installare il componente aggiuntivo Microsoft Outlook](integrations/outlook/integrations-microsoft-outlook.md)
   + Microsoft Teams {#ms-teams}
      + [Panoramica di Adobe Workfront per Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/workfront-for-microsoft-teams.html)
      + [Installare Adobe Workfront per Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/install-workfront-ms-teams.html)
      + [Accedere ad Adobe Workfront dai Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/access-workfront-from-ms-teams.html)
      + [Ricerca e condivisione di elementi Adobe Workfront nei Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/search-for-and-share-wf-items-in-ms-teams.html)
      + [Creare attività Adobe Workfront dai Microsoft Teams](https://experienceleague.adobe.com/docs/workfront/using/adobe-workfront-integrations/workfront-for-microsoft-teams/create-workfront-tasks-from-ms-teams.html)
...
+ Fusion {#fusion}
   + Benvenuto in Workfront Fusion {#welcome-to-workfront-fusion}
      + [Panoramica di Workfront Fusion](fusion/1-welcome-to-workfront-fusion/workfront-fusion-overview.md)
      + [Configurare i file di esercizio di Workfront Fusion](fusion/1-welcome-to-workfront-fusion/set-up-your-fusion-exercise-files-walkthrough.md)
   ...
   + Comprendere le nozioni di base {#understand-the-basics}
      ...
      + [Pannello di mappatura ed editor di formule](fusion/2-understand-the-basics/mapping-panel-and-formula-editor.md)
      + [Note importanti del pannello di mappatura](fusion/2-understand-the-basics/mapping-panel-important-notes.md)
      ...
      + [Procedura dettagliata sull’accesso alle versioni precedenti](fusion/2-understand-the-basics/access-previous-versions-walkthrough.md)
   + Connettori universali e indirizzamento {#universal-connectors-and-routing}
      + [Panoramica dell’esercizio dei connettori universali](fusion/3-universal-connectors-and-routing/universal-connectors-exercise-overview.md)
      + [Procedura dettagliata sull’introduzione ai connettori universali](fusion/3-universal-connectors-and-routing/introduction-to-universal-connectors-walkthrough.md)
      + [Comprendere i router](fusion/3-universal-connectors-and-routing/understand-routers.md)
      + [Procedura dettagliata dei router](fusion/3-universal-connectors-and-routing/routers-walkthrough.md)
      + [Pattern di routing comuni](fusion/3-universal-connectors-and-routing/common-routing-patterns.md)
      + [Procedura dettagliata sui pattern di routing](fusion/3-universal-connectors-and-routing/routing-patterns-walkthrough.md)
      + [Set-it e get-it](fusion/3-universal-connectors-and-routing/set-it-and-get-it.md)
      + [Procedura dettagliata su come ottenere/impostare le variabili](fusion/3-universal-connectors-and-routing/get-set-variables-walkthrough.md)
   + Iterazione e aggregazione {#iteration-and-aggregation}
      ...
      + [Introduzione alla procedura dettagliata degli iteratori](fusion/4-iteration-and-aggregation/introduction-to-iterators-walkthrough.md)
      + [Introduzione alle aggregazioni](fusion/4-iteration-and-aggregation/introduction-to-aggregations.md)
      + [Procedura dettagliata sull’aggregazione](fusion/4-iteration-and-aggregation/aggregation-walkthrough.md)
      + [Procedura dettagliata sull’aggregazione avanzata](fusion/4-iteration-and-aggregation/advanced-aggregation-walkthrough.md)
   + Storico di esecuzione e pianificazione {#execution-history-and-scheduling}
      ...
      + [Cicli e fasci di cicli di bilanciamento](fusion/5-execution-history-and-scheduling/balance-runs-cycles-and-bundles.md)
      + [Procedura dettagliata su cicli e bundle](fusion/5-execution-history-and-scheduling/runs-cycles-and-bundles-walkthrough.md)
   + Oltre i moduli di base {#beyond-basic-modules}
      + [Acquisisci familiarità con altre app e moduli comuni](fusion/6-beyond-basic-modules/become-familiar-with-additional-apps-and-common-modules.md)
      + [Interruttore](fusion/6-beyond-basic-modules/switch-it-up.md)
      + [Procedura dettagliata della funzione di commutazione](fusion/6-beyond-basic-modules/switch-function-walkthrough.md)
      + [Procedura dettagliata del modulo di switch](fusion/6-beyond-basic-modules/switch-module-walkthrough.md)
   ...
   + Strutture e archivi di dati {#data-structures-and-data-stores}
      + [Comprendere le strutture di dati](fusion/7-data-structures-and-data-stores/understand-data-structures.md)
      + [Procedura dettagliata delle strutture dei dati](fusion/7-data-structures-and-data-stores/data-structures-walkthrough.md)
      + [Comprendere gli archivi di dati](fusion/7-data-structures-and-data-stores/understand-data-stores.md)
      + [Procedura dettagliata degli archivi dati](fusion/7-data-structures-and-data-stores/data-stores-walkthrough.md)
   + bit funzionali finali e piastre {#final-functional-bits-and-bobs}
      + [Procedura dettagliata sull’app Workfront](fusion/8-final-functional-bits-and-bobs/workfront-app-walkthrough.md)
      ...
      + [Comprendere JSON negli scenari](fusion/8-final-functional-bits-and-bobs/understand-json-in-scenarios.md)
      + [Procedura dettagliata sull’utilizzo di JSON](fusion/8-final-functional-bits-and-bobs/working-with-json-walkthrough.md)
   + Risoluzione dei problemi e gestione degli errori {#troubleshooting-and-error-handling}
      + [Risoluzione dei problemi avanzata con lo strumento di sviluppo](fusion/9-troubleshooting-and-error-handling/advanced-troubleshooting-with-the-dev-tool.md)
      + [Procedura dettagliata sullo strumento di sviluppo](fusion/9-troubleshooting-and-error-handling/dev-tool-walkthrough.md)
      ...
      + [Procedura dettagliata sulle esecuzioni incomplete](fusion/9-troubleshooting-and-error-handling/incomplete-executions-walkthrough.md)
   + Amministrazione Workfront Fusion {#workfront-fusion-administration}
      ...
      + [Procedura dettagliata sull&#39;amministrazione](fusion/10-workfront-fusion-administration/administration-walkthrough.md)
   + Ottimizzazione e test della progettazione {#design-optimization-and-testing}
      ...
      + [Ottimizzazione dello scenario Workfront Fusion](fusion/11-design-optimization-and-testing/workfront-fusion-scenario-optimization.md)
      + [Accessibilità e chiarezza](fusion/11-design-optimization-and-testing/accessibility-and-clarity.md)
      + [Garanzie dello scenario](fusion/11-design-optimization-and-testing/scenario-guardrails.md)
      + [Test e lancio](fusion/11-design-optimization-and-testing/testing-considerations.md)
   + Esercizi {#exercises}
      + [Progettazione iniziale dello scenario](fusion/12-exercises/initial-scenario-design.md)
      ...
      + [Modulo di commutazione](fusion/12-exercises/switch-module.md)
      + [Webhook](fusion/12-exercises/webhooks.md)
      + [Strutture dati](fusion/12-exercises/data-structures.md)
      + [Archiviazione dati](fusion/12-exercises/data-stores.md)
...
+ Workfront Proof {#workfront-proof}
   ...
   + Amministrazione e configurazione {#administration-and-setup-for-proof}
      ...
      + [Imposta ruoli di bozza predefiniti](workfront-proof/administration-and-setup/set-default-proof-roles.md)
...
+ Workfront DAM {#workfront-dam-program}
   ...
   + Metadati e parole chiave {#metadata-and-keywords}
      ...
      + [Esamina la terminologia dei metadati](workfront-dam/metadata-and-keywords/review-the-terminology.md)
      + [Cercare risorse utilizzando metadati e parole chiave](workfront-dam/metadata-and-keywords/search-for-assets.md)
...
+ Agile {#agile}
   ...
   + Scrum {#scrum}
      + [Creare un team Scum agile](agile/create-a-scrum-agile-team.md)
      + [Gestisci il lavoro come team Scrum](agile/manage-work-scrum-team.md)
      + [Estrazione del backlog](agile/gooming-the-backlog.md)
...
+ Best practice {#best-practices}
   ...
   + [Filtri, visualizzazioni e raggruppamenti](best-practices/filters-views-groupings-bp.md)
